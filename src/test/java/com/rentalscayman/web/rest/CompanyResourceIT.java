...
public class CompanyResourceIT {
    ...
    public static Company createEntity(EntityManager em) {
        Company company = new Company().name(DEFAULT_NAME).phone(DEFAULT_PHONE).email(DEFAULT_EMAIL);
        return company;
    }
    ...
    public static Company createUpdatedEntity(EntityManager em) {
        Company company = new Company().name(UPDATED_NAME).phone(UPDATED_PHONE).email(UPDATED_EMAIL);
        return company;
    }
    ...
    public void updateCompany() throws Exception {
        ...
        updatedCompany.name(UPDATED_NAME).phone(UPDATED_PHONE).email(UPDATED_EMAIL);
